...
using CheckDieLinkedin.Config;
using CheckDieLinkedin.Service;
using Leaf.xNet;
using System.Windows.Forms;
//using LinkedinCheckerTools.View;
using System.Threading;
using System.Threading.Tasks;
using CheckDieLinkedin.Singleton;
using System.Diagnostics;
using System;
using CheckDieLinkedin.Models;
using CheckDieLinkedin.API;
...
namespace CheckDieLinkedin
{
    public partial class FormMain : Form
    {
        ...
        private void start_BtnClick(object sender, EventArgs e)
        {
            ...
            //TestCheckEmail test = new TestCheckEmail();
            //test.CheckDieEmails();
            ResetCounter();
        ...
        {
            LinkedinCheckDieAPI linkedinAPI = new LinkedinCheckDieAPI();
